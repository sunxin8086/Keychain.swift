...
open class Keychain {
    ...
    open class func value(forKey key: String) -> String? {
    ...
    open class func bool(forKey key: String) -> Bool {
        return value(forKey: key) == "true"
    }
    
    open class func removeValue(forKey key:String) -> Bool {
        return deleteValue(forKey: key)
    }
    
    open class func reset() -> Bool {
    ...
    open class func allValues() -> [[String: String]]?  {
